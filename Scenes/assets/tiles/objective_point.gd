...
func _process(_delta: float) -> void:
	...
	global_position = lerp(global_position, target_display_position, _delta* smoothing_speed)
	rotation = lerp (rotation, target_display_rotation, _delta * smoothing_speed)